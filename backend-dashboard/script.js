...
async function submitVisibleForm(e) {
  ...
  try {
    const response = await fetch("http://localhost:5000/submit-form", options);
    let result;
...
// let medSelectedFiles = [];
// let medicationSelectedFiles = [];

// function handleMedFileSelect(input) {
//   const listContainer = document.getElementById("deposit-file-list");
//   const maxFiles = 4;
//   const newFiles = Array.from(input.files);


//   medSelectedFiles = [...medSelectedFiles, ...newFiles].slice(0, maxFiles);


//   listContainer.innerHTML = "";

//   medSelectedFiles.forEach((file, index) => {
//     const wrapper = document.createElement("div");
//     wrapper.className =
//       "d-flex justify-content-between align-items-center bg-light p-2 rounded mb-1";

//     wrapper.innerHTML = `
//             <span class="text-truncate" style="max-width: 80%;">${file.name}</span>
//             <button type="button" class="btn btn-sm btn-danger" onclick="removeMedFile(${index})">✖</button>
//         `;
...
//   const maxFiles = 4; // Optional: if you want a limit
//   const newFiles = Array.from(input.files);

//   medicationSelectedFiles = [...medicationSelectedFiles || [], ...newFiles].slice(0, maxFiles);
...
// function removeMedFile(index) {
//   medSelectedFiles.splice(index, 1);
//   const listContainer = document.getElementById("deposit-file-list");
//   listContainer.innerHTML = "";

//   medSelectedFiles.forEach((file, i) => {
//     const wrapper = document.createElement("div");
//     wrapper.className =
//       "d-flex justify-content-between align-items-center bg-light p-2 rounded mb-1";
...
//     wrapper.innerHTML = `
//             <span class="text-truncate" style="max-width: 80%;">${file.name}</span>
//             <button type="button" class="btn btn-sm btn-danger" onclick="removeMedFile(${i})">✖</button>
//         `;
